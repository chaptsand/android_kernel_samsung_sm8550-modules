...
#if defined(CONFIG_SEC_Q5Q_PROJECT) || defined(CONFIG_SEC_B5Q_PROJECT)
...
struct csiphy_reg_t datarate_212_1p2Gsps[] = {
	...
	{0x026C, 0x1D, 0x00, CSIPHY_DEFAULT_PARAMS},
	{0x028C, 0x38, 0x00, CSIPHY_DEFAULT_PARAMS},
	{0x0270, 0x00, 0x00, CSIPHY_DEFAULT_PARAMS},
	{0x0274, 0x03, 0x00, CSIPHY_DEFAULT_PARAMS},
	{0x0668, 0xF1, 0x00, CSIPHY_DEFAULT_PARAMS},
	{0x0694, 0x01, 0x00, CSIPHY_DEFAULT_PARAMS},
	...
	{0x066C, 0x1D, 0x00, CSIPHY_DEFAULT_PARAMS},
	{0x068C, 0x38, 0x00, CSIPHY_DEFAULT_PARAMS},
	{0x0670, 0x00, 0x00, CSIPHY_DEFAULT_PARAMS},
	{0x0674, 0x03, 0x00, CSIPHY_DEFAULT_PARAMS},
	{0x0A68, 0xF1, 0x00, CSIPHY_DEFAULT_PARAMS},
	{0x0A94, 0x01, 0x00, CSIPHY_DEFAULT_PARAMS},
	...
	{0x0A6C, 0x1D, 0x00, CSIPHY_DEFAULT_PARAMS},
	{0x0A8C, 0x38, 0x00, CSIPHY_DEFAULT_PARAMS},
	{0x0A70, 0x00, 0x00, CSIPHY_DEFAULT_PARAMS},
	{0x0A74, 0x03, 0x0A, CSIPHY_DEFAULT_PARAMS},
	/* Datarate Sensitive*/
...
struct csiphy_reg_t datarate_212_1p2Gsps[] = {
	...
	{0x028C, 0x1A, 0x00, CSIPHY_DEFAULT_PARAMS},
	...
	{0x068C, 0x1A, 0x00, CSIPHY_DEFAULT_PARAMS},
	...
	{0x0A8C, 0x1A, 0x00, CSIPHY_DEFAULT_PARAMS},
...
struct csiphy_reg_t datarate_212_1p2Gsps[] = {
	...
	{0x0278, 0x45, 0x00, CSIPHY_CDR_LN_SETTINGS},
	{0x026C, 0x3D, 0x00, CSIPHY_DEFAULT_PARAMS},
	{0x028C, 0x39, 0x00, CSIPHY_DEFAULT_PARAMS},
	{0x0270, 0x02, 0x00, CSIPHY_DEFAULT_PARAMS},
	...
	{0x0678, 0x45, 0x00, CSIPHY_CDR_LN_SETTINGS},
	{0x066C, 0x3D, 0x00, CSIPHY_DEFAULT_PARAMS},
	{0x068C, 0x39, 0x00, CSIPHY_DEFAULT_PARAMS},
	{0x0670, 0x02, 0x00, CSIPHY_DEFAULT_PARAMS},
	...
	{0x0A78, 0x45, 0x00, CSIPHY_CDR_LN_SETTINGS},
	{0x0A6C, 0x3D, 0x00, CSIPHY_DEFAULT_PARAMS},
	{0x0A8C, 0x39, 0x00, CSIPHY_DEFAULT_PARAMS},
	{0x0A70, 0x02, 0x00, CSIPHY_DEFAULT_PARAMS},
...
struct csiphy_reg_t datarate_212_2p0Gsps_wide[] = {
	...
	{0x0294, 0x01, 0x00, CSIPHY_DEFAULT_PARAMS},
	{0x0288, 0x20, 0x00, CSIPHY_DEFAULT_PARAMS},
	{0x0278, 0x24, 0x00, CSIPHY_CDR_LN_SETTINGS},
	{0x026C, 0x1D, 0x00, CSIPHY_DEFAULT_PARAMS},
	{0x028C, 0x30, 0x00, CSIPHY_DEFAULT_PARAMS},
	{0x0270, 0x00, 0x00, CSIPHY_DEFAULT_PARAMS},
	{0x0274, 0x03, 0x00, CSIPHY_DEFAULT_PARAMS},
	...
	{0x0694, 0x01, 0x00, CSIPHY_DEFAULT_PARAMS},
	{0x0688, 0x20, 0x00, CSIPHY_DEFAULT_PARAMS},
	{0x0678, 0x24, 0x00, CSIPHY_CDR_LN_SETTINGS},
	{0x066C, 0x1D, 0x00, CSIPHY_DEFAULT_PARAMS},
	{0x068C, 0x30, 0x00, CSIPHY_DEFAULT_PARAMS},
	{0x0670, 0x00, 0x00, CSIPHY_DEFAULT_PARAMS},
	{0x0674, 0x03, 0x00, CSIPHY_DEFAULT_PARAMS},
	...
	{0x0A94, 0x01, 0x00, CSIPHY_DEFAULT_PARAMS},
	{0x0A88, 0x20, 0x00, CSIPHY_DEFAULT_PARAMS},
	{0x0A78, 0x24, 0x00, CSIPHY_CDR_LN_SETTINGS},
	{0x0A6C, 0x1D, 0x00, CSIPHY_DEFAULT_PARAMS},
	{0x0A8C, 0x30, 0x00, CSIPHY_DEFAULT_PARAMS},
	{0x0A70, 0x00, 0x00, CSIPHY_DEFAULT_PARAMS},
	{0x0A74, 0x03, 0x0A, CSIPHY_DEFAULT_PARAMS},
...
struct csiphy_reg_t datarate_212_3p3Gsps[] = {
	...
	{0x026C, 0x15, 0x00, CSIPHY_DEFAULT_PARAMS},
	{0x028C, 0x30, 0x00, CSIPHY_DEFAULT_PARAMS},
#if defined(CONFIG_SEC_B5Q_PROJECT)
	...
	{0x066C, 0x15, 0x00, CSIPHY_DEFAULT_PARAMS},
	{0x068C, 0x30, 0x00, CSIPHY_DEFAULT_PARAMS},
#if defined(CONFIG_SEC_B5Q_PROJECT)
	...
	{0x0A6C, 0x15, 0x00, CSIPHY_DEFAULT_PARAMS},
	{0x0A8C, 0x30, 0x00, CSIPHY_DEFAULT_PARAMS},
#if defined(CONFIG_SEC_B5Q_PROJECT)
	{0x0A70, 0x03, 0x00, CSIPHY_DEFAULT_PARAMS},
	{0x0A74, 0x02, 0x00, CSIPHY_DEFAULT_PARAMS},
#else
	{0x0A70, 0x01, 0x00, CSIPHY_DEFAULT_PARAMS},
	{0x0A74, 0x00, 0x0A, CSIPHY_DEFAULT_PARAMS},
#endif
...
struct csiphy_reg_t datarate_212_3p5Gsps[] = {
	...
	{0x026C, 0x15, 0x00, CSIPHY_DEFAULT_PARAMS},
#if defined(CONFIG_SEC_Q5Q_PROJECT)
	{0x028C, 0x5E, 0x00, CSIPHY_DEFAULT_PARAMS},
	{0x0270, 0x02, 0x00, CSIPHY_DEFAULT_PARAMS},
	{0x0274, 0x06, 0x00, CSIPHY_DEFAULT_PARAMS},
#else
	{0x028C, 0x30, 0x00, CSIPHY_DEFAULT_PARAMS},
	{0x0270, 0x01, 0x00, CSIPHY_DEFAULT_PARAMS},
	{0x0274, 0x00, 0x00, CSIPHY_DEFAULT_PARAMS},
	...
	{0x066C, 0x15, 0x00, CSIPHY_DEFAULT_PARAMS},
#if defined(CONFIG_SEC_Q5Q_PROJECT)
	{0x068C, 0x5E, 0x00, CSIPHY_DEFAULT_PARAMS},
	{0x0670, 0x02, 0x00, CSIPHY_DEFAULT_PARAMS},
	{0x0674, 0x06, 0x00, CSIPHY_DEFAULT_PARAMS},
#else
	{0x068C, 0x30, 0x00, CSIPHY_DEFAULT_PARAMS},
	{0x0670, 0x01, 0x00, CSIPHY_DEFAULT_PARAMS},
	{0x0674, 0x00, 0x00, CSIPHY_DEFAULT_PARAMS},
	...
	{0x0A6C, 0x15, 0x00, CSIPHY_DEFAULT_PARAMS},
#if defined(CONFIG_SEC_Q5Q_PROJECT)
	{0x0A8C, 0x5E, 0x00, CSIPHY_DEFAULT_PARAMS},
	{0x0A70, 0x02, 0x00, CSIPHY_DEFAULT_PARAMS},
	{0x0A74, 0x06, 0x0A, CSIPHY_DEFAULT_PARAMS},
#else
	{0x0A8C, 0x30, 0x00, CSIPHY_DEFAULT_PARAMS},
	{0x0A70, 0x01, 0x00, CSIPHY_DEFAULT_PARAMS},
	{0x0A74, 0x00, 0x0A, CSIPHY_DEFAULT_PARAMS},
...
static struct data_rate_reg_info_t data_rate_settings_2_1_2[] = {
	{
		...
		.data_rate_reg_array[1] = datarate_212_100Msps,
		.data_rate_reg_array[2] = datarate_212_100Msps,
	...
	},
	{
		...
		.data_rate_reg_array[1] = datarate_212_200Msps,
		.data_rate_reg_array[2] = datarate_212_200Msps,
	...
	},
	{
		...
		.data_rate_reg_array[1] = datarate_212_300Msps,
		.data_rate_reg_array[2] = datarate_212_300Msps,
	...
	},
	{
		...
		.data_rate_reg_array[1] = datarate_212_350Msps,
		.data_rate_reg_array[2] = datarate_212_350Msps,
	...
	},
	{
		...
		.data_rate_reg_array[1] = datarate_212_400Msps,
		.data_rate_reg_array[2] = datarate_212_400Msps,
	...
	},
	{
		...
		.data_rate_reg_array[1] = datarate_212_500Msps,
		.data_rate_reg_array[2] = datarate_212_500Msps,
	...
	},
	{
		...
		.data_rate_reg_array[1] = datarate_212_600Msps,
		.data_rate_reg_array[2] = datarate_212_600Msps,
	...
	},
	{
		...
		.data_rate_reg_array[1] = datarate_212_700Msps,
		.data_rate_reg_array[2] = datarate_212_700Msps,
	...
	},
	{
		...
		.data_rate_reg_array[1] = datarate_212_800Msps,
		.data_rate_reg_array[2] = datarate_212_800Msps,
	...
	},
	{
		...
		.data_rate_reg_array[1] = datarate_212_900Msps,
		.data_rate_reg_array[2] = datarate_212_900Msps,
	...
	},
	{
		...
		.data_rate_reg_array[1] = datarate_212_1p0Gsps,
		.data_rate_reg_array[2] = datarate_212_1p0Gsps,
	...
	},
	{
		...
		.data_rate_reg_array[1] = datarate_212_1p2Gsps,
		.data_rate_reg_array[2] = datarate_212_1p2Gsps,
	...
	},
	{
		...
		.data_rate_reg_array[1] = datarate_212_1p5Gsps,
		.data_rate_reg_array[2] = datarate_212_1p5Gsps,
	...
	},
	{
		...
		.data_rate_reg_array[1] = datarate_212_1p7Gsps,
		.data_rate_reg_array[2] = datarate_212_1p7Gsps,
...
#if defined(CONFIG_SEC_DM3Q_PROJECT)
	{
		...
		.data_rate_reg_array[0] = datarate_212_2p0Gsps_front, //for DM3 front camera
		.data_rate_reg_array[1] = datarate_212_2p0Gsps_wide, //for DM3 wide camera
		.data_rate_reg_array[2] = datarate_212_2p0Gsps,
...
#else
	{
		...
		.data_rate_reg_array[1] = datarate_212_2p0Gsps,
		.data_rate_reg_array[2] = datarate_212_2p0Gsps,
		.data_rate_reg_array_size = ARRAY_SIZE(datarate_212_2p0Gsps),
	},
#endif
	{
		...
		.data_rate_reg_array[1] = datarate_212_2p1Gsps,
		.data_rate_reg_array[2] = datarate_212_2p1Gsps,
	...
	},
	{
		...
		.data_rate_reg_array[1] = datarate_212_2p35Gsps,
		.data_rate_reg_array[2] = datarate_212_2p35Gsps,
	...
	},
	{
		...
		.data_rate_reg_array[1] = datarate_212_2p5Gsps,
		.data_rate_reg_array[2] = datarate_212_2p5Gsps,
	...
	},
	{
		...
		.data_rate_reg_array[1] = datarate_212_2p6Gsps,
		.data_rate_reg_array[2] = datarate_212_2p6Gsps,
	...
	},
	{
		...
		.data_rate_reg_array[1] = datarate_212_2p8Gsps,
		.data_rate_reg_array[2] = datarate_212_2p8Gsps,
	...
	},
	{
		...
		.data_rate_reg_array[1] = datarate_212_3p0Gsps,
		.data_rate_reg_array[2] = datarate_212_3p0Gsps,
	...
	},
	{
		...
		.data_rate_reg_array[1] = datarate_212_3p3Gsps,
		.data_rate_reg_array[2] = datarate_212_3p3Gsps,
	...
	},
	{
		...
		.data_rate_reg_array[1] = datarate_212_3p5Gsps,
		.data_rate_reg_array[2] = datarate_212_3p5Gsps,
	...
	},
	{
		...
		.data_rate_reg_array[1] = datarate_212_4p0Gsps,
		.data_rate_reg_array[2] = datarate_212_4p0Gsps,
	...
	},
	{
		...
		.data_rate_reg_array[1] = datarate_212_4p5Gsps,
		.data_rate_reg_array[2] = datarate_212_4p5Gsps,
	...
	},
	{
		...
		.data_rate_reg_array[1] = datarate_212_5p0Gsps,
		.data_rate_reg_array[2] = datarate_212_5p0Gsps,
	...
	},
	{
		...
		.data_rate_reg_array[1] = datarate_212_5p5Gsps,
		.data_rate_reg_array[2] = datarate_212_5p5Gsps,
	...
	},
	{
		...
		.data_rate_reg_array[1] = datarate_212_6p0Gsps,
		.data_rate_reg_array[2] = datarate_212_6p0Gsps,
